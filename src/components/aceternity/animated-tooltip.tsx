...
export const AnimatedTooltip = ({
  ...
  const springConfig = { stiffness: 75, damping: 25 }
      ...
      {items.map((item, idx) => (
        ...
        >
          ...
          <Image
            ...
            src={item.image}
            alt={item.name}
            className="relative !m-0 h-10 w-10 rounded-full border-2 border-neutral-600 object-cover object-top !p-0 transition duration-500 group-hover:z-30 group-hover:scale-105"
          />
        </div>
      ))}
    </>
