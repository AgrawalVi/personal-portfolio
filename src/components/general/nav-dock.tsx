...
const Icons = {
  email: (props: IconProps) => (
    <MailIcon className="h-full w-full" {...props} />
  ),
...
const links = [
  { href: '/', icon: <HomeIcon className="h-full w-full" />, title: 'Home' },
  {
    href: '/#education',
  ...
  {
    href: '/#projects',
    icon: <Folders className="h-full w-full" />,
    title: 'Projects',
  },
  {
    href: '/blog',
  ...
  { href: 'mailto:zvishrut@gmail.com', icon: <Icons.email />, title: 'Email' },
]
