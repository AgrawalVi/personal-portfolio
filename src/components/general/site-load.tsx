  ...
  useGSAP(() => {
    ...
    gsap
      ...
      .fromTo(
        '#progressBar',
        { opacity: 0 },
        { duration: 2, delay: 0, opacity: 100 },
      )
      .to('#textToAnimate', {
        duration: 0.92,
        delay: 1,
        text: 'Beginning Initialization Sequence',
        ease: 'none',
      })
      ...
      .to('#textToAnimate', {
        duration: 1.92,
        delay: 0,
        text: 'npx create-next-app@latest --ts --tailwind --app',
        ease: 'none',
      })
      .to('#textToAnimate', { duration: 0, delay: 1, text: 'n', ease: 'none' })
      .to('#textToAnimate', {
        duration: 2.04,
        delay: 0,
        text: 'npm i framer-motion clsx tailwind-merge @gsap/react',
        ease: 'none',
      })
