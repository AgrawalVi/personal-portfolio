          ...
          <PageContainer>
            <PageSection title="Summary" id="summary">
              <p>
                ...
                showcase my work. As someone who doesn't specialize in design, I
                aimed for a content-driven approach, acknowledging that my UI
                skills are average at best. A highlight still in development is
                a photography section that reflects one of my favorite hobbies.
              </p>
            </PageSection>
            ...
            <PageSection title="Takeaways" id="takeaways">
              <p>
                ...
                Reflecting on my past projects and documenting them has not only
                allowed me to appreciate my growth but also ignited my
            ...
            <PageSection title="The Current State" id="current-state">
              <p>
                What you see now represents the current version of my portfolio,
                but exciting developments are underway:
              </p>
              <ul>
                <li>
                  <strong>Photography Section:</strong> I am developing a unique
                  and interactive section to display my photography. This
                  project is particularly close to my heart, and I am eager to
                  unveil the creative concepts I've been exploring.
                </li>
                <li>
