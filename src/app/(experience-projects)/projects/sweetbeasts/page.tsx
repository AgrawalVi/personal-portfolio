          ...
          <PageContainer>
            <PageSection title="Summary" id="summary">
              <p>
                ...
                I lead a team of three in developing and testing a bespoke
                e-commerce platform. My responsibilities span all technical and
                operational aspects of the project, which features an advanced
            ...
            <PageSection title="Why build custom?" id="why">
              ...
              <ul>
                ...
                <li>
                  ...
                  steering clear of the typical clutter found on many e-commerce
                  sites.
                </li>
              </ul>
            </PageSection>
            ...
            <PageSection title="Key Features" id="key-features">
              ...
              <ul>
                <li>
                  All data fetching, except for cart management which uses React
                  Query, is performed using Next.js server components, enhancing
                  security and user experience.
                </li>
                <li>
                  Efficient handling of both remote and local cart tracking for
                  guests and registered users, including cart merging and
                ...
                <li>
                  A modern, playful, and responsive UI that's visually appealing
            ...
            <PageSection title="The Current State" id="current-state">
              <p>
                ...
                first plushie shipment. We expect to go live within the next few
                weeks. Despite nearing completion, continual improvement remains
                a focus:
              </p>
              <ul>
